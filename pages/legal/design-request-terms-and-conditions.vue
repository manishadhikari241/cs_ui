<template>
  <div class="page legal design-request-terms-and-conditions">
    <b-container>
      <b-row>
        <b-col md="4">
          <LegalMenu />
        ...
        <b-col md="8">
          <Legal :slug="'design-request-terms-and-conditions'" />
        </b-col>
      </b-row>
    </b-container>
  </div>
...
export default {
  ...
  asyncData (context) {
    return context.$axios.get('/pages/design-request-terms-and-conditions')
      .then((res) => {

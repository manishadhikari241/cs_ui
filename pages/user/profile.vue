                            ...
                            <form @submit.prevent="updateUser">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="value">
                                        ...
                                        <vue-tel-input v-model="user.mobile" :placeholder="$t('mobile')"
                                                       :enabledCountryCode="true" :validCharactersOnly="true"
                                                       :disabledFetchingCountry="true" :defaultCountry="user.country"

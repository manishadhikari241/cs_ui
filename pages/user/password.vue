            ...
            <div class="password-container">
              ...
              <form @submit.prevent="updatePassword">
                ...
                <div class="info-row">
                  ...
                  <div class="value">
                    <b-input type="password" v-model="user.new_password" :class="{'success': user.new_password.length && passwordsMatch}" required></b-input>
                  </div>
                </div>
                <div class="info-row">
                  <div class="prop">{{ $t('password_confirmation') }}</div>
                  <div class="value">
                    <b-input type="password" v-model="user.new_password_confirm" :class="{'success': user.new_password_confirm.length && passwordsMatch}" required></b-input>
                  </div>
                </div>
                <b-button type="submit" :disabled="updating || !passwordsMatch">{{ $t('update') }}</b-button>
              </form>
            </div>
          </div>
        </b-col>

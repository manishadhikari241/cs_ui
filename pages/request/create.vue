                    ...
                    <div class="row">
                        <form class="designRequestForm" @submit.prevent="submitRequest">
                            <b-row>
                                ...
                                <b-col md="9">
                                    <b-input :placeholder="$t('give_us_the_name')" v-model="request.name"
                                             required></b-input>
                                </b-col>
                            </b-row>
                            <b-row>
                            ...
                            <b-row>
                                ...
                                <b-col md="9">
                                    <b-form-file ref="file" v-model="request.file" :state="Boolean(request.preview)"
                                                 :browse-text="$t('browse')"

                                                 :placeholder="$t('upload_drop_free_req')"
                                                 drop-placeholder="Drop file here..." @change="generatePreview"

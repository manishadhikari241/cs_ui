<template>
    <div class="page create-request">
        <div class="component pageinfo">
            ...
            <p class="pageinfo-description-free">{{ $t('a_new_collection_will_be') }}</p>
        ...
        <form class="designRequestForm" @submit.prevent="submitRequest">
            <b-row>
                <b-col md="2">{{ $t('name_of_request') }}</b-col>
                <b-col md="9">
                    <b-input :placeholder="$t('give_us_the_name')" v-model="request.name" required></b-input>
                </b-col>
            </b-row>
            <b-row>
            ...
            <b-row >
                ...
                <b-col md="9">
                    <b-form-file ref="file"  v-model="request.file" :state="Boolean(request.preview)" :browse-text="$t('browse')"

                                 :placeholder="$t('upload_drop_free_req')"
                                 drop-placeholder="Drop file here..." @change="generatePreview" required></b-form-file>
   ...
   <div class="important-request-message">
              ...
              <p class="important-description">{{ $t('the_design_we_create_free') }}</p>
              <p class="important-description">{{ $t('the_request_is_for_free') }}</p>
              <p class="important-description">{{ $t('one_request_at_time') }}</p>
            ...
            <b-row>
                <b-col>
                    <b-form-checkbox name="accept" v-model="accept" required><span
                            v-html="$t('accept_request_terms')"></span></b-form-checkbox>
                </b-col>
            </b-row>
            ...
            <b-row>
                <b-col>
                    <div class="actions">
                        <button class="send_application" type="submit" :disabled="submitting">{{ $t('send_application')
                            }}
                        </button>
                        <button class="back" :disabled="submitting">
                            <nuxt-link :to="localePath('/request')">{{ $t('back') }}</nuxt-link>
                        </button>
                    </div>
                </b-col>
            </b-row>

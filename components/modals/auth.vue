                    ...
                    <b-col class="right">
                        <div class="authentication" v-show="mode === 1">
                            ...
                            <form class="login" @submit.prevent="login">
                                ...
                                <div class="buttons">
                                    <b-button type="submit" class="login_button" :disabled="loading">{{ $t('login') }}</b-button>
                                    <b-button type="button" class="forgot_password" @click="setAuthModalMode(3)" :disabled="loading">{{
                                        $t('forgot_password') }}
                                    </b-button>
                                </div>
                            </form>
                        ...
                        <div class="registration" v-show="mode === 2">
                            ...
                            <br>
                            <form @submit.prevent="register" v-show="!confirmAfterRegisterMode">
                                <b-row>
                                    <b-col>
                                ...
                                <vue-tel-input name="mobile" v-model="registerInfo.mobile" :placeholder="$t('mobile')"
                                               :dynamicPlaceholder="true" :enabledCountryCode="true"
                                ...
                                <div class="buttons">
                                    <b-button type="submit" class="join-now-btn btn-primary" :disabled="loading">{{ $t('join_now')
                                        }}
                                    </b-button>
                        ...
                        <div class="forgot" v-show="mode === 3">
                            ...
                            <form @submit.prevent="sendResetPasswordEmail">
                                <b-input type="email" name="email" v-model="forgotInfo.email" :placeholder="$t('email')"
                                         required></b-input>
                                <div class="buttons">
                                    <b-button type="submit" :disabled="loading">{{ $t('reset_password') }}</b-button>
                                </div>
                            </form>
                            <br><br>
                        ...
                        <div class="reset" v-show="mode === 4">
                            ...
                            <form @submit.prevent="resetPassword">
                                ...
                                <b-input
                                        ...
                                        :placeholder="$t('password')" minlength="8" required></b-input>
                                <b-input
                                        :class="{'confirmed': resetInfo.password.length >= 8 && resetInfo.password == resetInfo.password_confirmation}"
                                        type="password" name="password_confirmation"
                                        v-model="resetInfo.password_confirmation" :placeholder="$t('confirm_password')"
